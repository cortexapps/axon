...
from handler import CortexScheduled
from utils import (
...
from cortex_axon.handler import CortexWebhook
...
def test_register(mock_agent, mock_cortex_api):  # noqa: F811
    ...
    mock_agent.mock.RegisterHandler.side_effect = lambda request, context: register_handler(request, assert_queue)
    mock_agent.mock.Dispatch.side_effect = lambda self, request_iterator, context: dispatch_server(request_iterator)
