...
type HttpResponse struct {
	...
	// True is message was not successfully dispatched
...
const file_tunnel_proto_rawDesc = "" +
	...
	"\rTunnelService\x12^\n" +
	"\x06Tunnel\x12'.cortex.axon.tunnel.TunnelClientMessage\x1a'.cortex.axon.tunnel.TunnelServerMessage(\x010\x01B%Z#github.com/cortexapps/axon/tunnelpbb\x06proto3"
